 ...
 *
 * @details Reads the TX characteristic CCCD from the SoftDevice for @p conn_handle.
 *          If notifications are enabled, sends the data via
 *          @ref sd_ble_gatts_hvx. If the peer has not enabled notifications, or
 *          the CCCD cannot be read, the function fails and does not change the
 *          TX attribute value in the GATT database.
 *
